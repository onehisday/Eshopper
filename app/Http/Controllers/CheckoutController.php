...
{
    private $vnp_TmnCode  = "5BBJJCSA";
    private $vnp_HashSecret   = "HQSJBHIFPFDJIZUPLAEKARIKQIJIRCEP";
    ...
    public function store(Request $request)
    {
        ...
        else if(isset($request->payment) && $request->payment == 'vnpay')
        {
            ...
            $vnp_TmnCode = "5BBJJCSA"; 
            $vnp_HashSecret = "HQSJBHIFPFDJIZUPLAEKARIKQIJIRCEP"; 
